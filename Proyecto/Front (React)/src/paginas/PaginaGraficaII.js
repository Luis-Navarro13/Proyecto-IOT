...
import Chart from 'C:/Users/luisn/OneDrive/Escritorio/3/IoT/Proyecto2/PaginaInicio/src/charts/ChartII';
import Tabla from 'C:/Users/luisn/OneDrive/Escritorio/3/IoT/Proyecto2/PaginaInicio/src/tablas/tablachartII.jsx';
function PaginaGraficaII() {
  return (
    <div>
    <Grid container spacing={0} style={{ marginLeft: '120px' }}>
      ...
      <Grid xs={10}>
        <div className='Rectangulogris' style={{justifyContent:'center'}} >
          ...
          <h1 className="texto">Grafica Presiones-Tiempo</h1>
...
export default PaginaGraficaII;
