...
def insert_temperatura(distancia, presion, temperatura):
    mycursor = mydb.cursor()
    sql = "INSERT INTO medicion (distancia, presion, temperatura) VALUES (%s, %s, %s)"
    data = (distancia, presion, temperatura)
...
while True:
    ...
    insert_temperatura(distance, pressure, temp)
